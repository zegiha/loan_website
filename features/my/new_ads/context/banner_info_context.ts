...
interface IBanner_info_context {
  ad_req_data: Array<{name: TAds_name, req_data: TAll_req, price: number}>,
  set_ad_req_data: React.Dispatch<React.SetStateAction<Array<{name: TAds_name, req_data: TAll_req, price: number}>>>,
}
